...
import com.newthinkank.helloworld.app.R;
import android.widget.Toast;
import com.newthinkank.helloworld.app.DBTools;
import com.newthinkank.helloworld.app.User;
                        ...
                        switch (which) {
                            case DialogInterface.BUTTON_POSITIVE:
                                ...
                                try {
                                    ...
                                    myToast.show();
                                    Intent myIntent;
                                    myIntent = new Intent(LoginActivity.this, MyActivity.class);
                                    LoginActivity.this.startActivity(myIntent);
                                } finally {
                                    if (dbTools != null)
                                        dbTools.close();
